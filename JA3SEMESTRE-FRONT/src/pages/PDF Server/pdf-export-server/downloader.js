...
const PROJECT_ROOT = fs.existsSync(path.join(__dirname, '.', 'package.json')) ? path.join(__dirname, './node_modules/puppeteer') : path.join(__dirname, '..', '../node_modules/puppeteer');
